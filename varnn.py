...
Original file is located at
    https://colab.research.google.com/drive/1Z7ASw12s2UmteE_FdyfZg5IcvO0nVnD0
"""
...
def VARNeuralNetwork(df,
    ...
    #############################
    # Create the model
    model = VARNN(input_size, hidden_size, output_size).to(device)
...
"""**Experiments on var datasets**"""

data= pd.read_csv('MSFT.csv')
data = data.drop('Unnamed: 0' , axis = 1)

horizon_length = 5
exo_test = data.iloc[-horizon_length:]
forecast_df = VARNeuralNetwork(data , exo_test , m_steps = horizon_length, num_epochs = 100 , exo = None, standardise = False , differencing = False , hidden_size = 4)
metric_df = perform_evaluation( df = data, forecasts_df = forecast_df , horizon_length = horizon_length)
forecast_df.to_csv('5_1_msft_varnn_forecast.csv')
metric_df.to_csv('5_1_msft_varnn_metrics.csv')

horizon_length = 10
exo_test = data.iloc[-horizon_length:]
forecast_df = VARNeuralNetwork(data , exo_test , m_steps = horizon_length, num_epochs = 500 , exo = None, standardise = True , differencing = False , hidden_size = 4)
metric_df = perform_evaluation( df = data, forecasts_df = forecast_df , horizon_length = horizon_length)
forecast_df.to_csv('10_1_msft_varnn_forecast.csv')
metric_df.to_csv('10_1_msft_varnn_metrics.csv')

data1 = pd.read_csv('MSFT.csv')
data1 = data1.drop('Unnamed: 0' , axis = 1)

horizon_length = 5
exo_test = data.iloc[-horizon_length:]
forecast_df = VARNeuralNetwork(data , exo_test , m_steps = horizon_length, num_epochs = 500 , exo = None, standardise = False , differencing = False , hidden_size = 4)
metric_df = perform_evaluation( df = data, forecasts_df = forecast_df , horizon_length = horizon_length)
forecast_df.to_csv('5_1_msft_varnn_forecast.csv')
metric_df.to_csv('5_1_msft_varnn_metrics.csv')
...
horizon_length = 10
exo_test = data.iloc[-horizon_length:]
forecast_df = VARNeuralNetwork(data , exo_test , m_steps = horizon_length, num_epochs = 500 , exo = None, standardise = True , differencing = False , hidden_size = 6)
metric_df = perform_evaluation( df = data, forecasts_df = forecast_df , horizon_length = horizon_length)
forecast_df.to_csv('10_1_msft_varnn_forecast.csv')
metric_df.to_csv('10_1_msft_varnn_metrics.csv')